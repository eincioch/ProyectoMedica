...
Public Class Imprimir
    ...
    Public EncabezadoElementos As String = "CANT   DESCRIPCION          IMPORTE"
    ...
    'Public Sub AnadirElemento(ByVal codigo As String, ByVal elemento As String, ByVal cantidad As String, ByVal precio As String)
    ...
    Private Sub DibujaElementos()
        ...
        gfx.DrawString(EncabezadoElementos, FuenteImpresa, ColorDeLaFuente, MargenIzquierdo, Renglon(), New StringFormat)
